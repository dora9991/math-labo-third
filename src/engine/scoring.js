...
export const RELEARN_STREAK_TARGET = 5;    // 【2026-09-26改訂】学び直しで「5問れんぞく正解」すると、その単元のまちがいがノートから消える（翌日確認の段階は廃止）
export const RELEARN_CONFIRM_CORRECT = 1;  // 翌日以降の確認で完全クリアに必要な正解数
export const RELEARN_CONFIRM_COIN = 70;    // 5問れんぞく正解でなおしたときのごほうびコイン（クリスタルは出さない・2026-07-19に8→70へ引き上げ）
